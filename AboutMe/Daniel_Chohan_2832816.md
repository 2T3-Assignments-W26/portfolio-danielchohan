...
* Lead a team of lifeguards throughout the summer.
* Handled lifesaving situations.
* Helped organize many meetings.
* Handled any complaints and high-stress discussions with members of the community and city. 
...
| Technical | Certifications | Communications |
|-----------|----------------|----------------|
|Programming(C#)|LifeSaving Society National Lifeguard Certificate| Conflict De-Escalation|
|Programming(Java)|First Aid and CPR Certificate| Customer Rapport Building
|Programming(HTML)|Swim Instructor Cerificate| Ability to explain complex concepts to others|
|Programming(CSS)| WordPress Certificate | Active Listening

## Education

| Degree | School | Year|
|--------|--------|-----|
|High School Degree|MacDonald HighSchool|2018-2023|
|DEC|John Abbott College|2023-2025|
|DEC|John Abbott College|2025-Present|